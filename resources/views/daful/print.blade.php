...
@section('page-name','Daftar Ulang')
                ...
                <div class="row">
                    ...
                    <table class="table card-table table-hover table-vcenter text-wrap title" id="print">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" id="jumlah-0" value="{{ $item->jumlah_bayar }}"></td>
                    ...
                    <table class="table card-table table-vcenter text-wrap title">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%;">IDR. <span id="total">{{ format_idr($items->sum('jumlah_bayar')) }}</span></td>
                        </tr>
                        <tr>
                            <td style="width: 60%"></td>
