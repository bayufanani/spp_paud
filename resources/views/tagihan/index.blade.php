...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            @if(session()->has('msg') && !session()->has('daful'))
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('daful.create') }}" class="btn btn-outline-primary btn-sm ml-5">Tambah Tagihan Daftar Ulang</a>
            </div>
            @if(session()->has('msg') && session()->has('daful'))
            <div class="card-alert alert alert-{{ session()->get('type') }}" id="message" style="border-radius: 0px !important">
                @if(session()->get('type') == 'success')
