                ...
                <div class="row">
                    ...
                    <table class="table card-table table-hover table-vcenter text-wrap title" id="print">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 60%">
                                    <input type="text" class="form-control" value="{{ $item->keterangan }}">
                                </td>
                                <td><input type="text" class="form-control harga" data-id="0" value="{{ $item->tipe == 'in' ? 'UANG MASUK' : 'UANG KELUAR' }}"></td>
                                <td><input type="text" class="form-control" id="jumlah-0" value="{{ format_idr($item->jumlah) }}"></td>
                            </tr>
                            @endforeach
                            <tr id="newrow"></tr>
                        </tbody>
                    ...
                    <table class="table card-table table-vcenter text-wrap title">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%;">IDR. <span id="total">{{ format_idr($items->sum('jumlah')) }}</span></td>
                        </tr>
                        <tr>
                            <td style="width: 60%"></td>
